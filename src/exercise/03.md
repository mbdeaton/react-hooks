...
State should reside close to where it's needed, so when some state is shared,
the `useState` hook should live in the lowest common parent of the relevant
components.

#### Tips

In the simple case of state being used by only one component, be sure to make it
reside in that component. This is clean coding, and will make give your app a
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=03%3A%20Lifting%20state&em=brett.deaton%40gmail.com).
