...
#### Key Takeaway
For `[x, setX] = useState()`, the component is re-rendered whenever useState
is called.

#### Tips
Hooks go inside the function body of a component.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=brett.deaton%40gmail.com).
